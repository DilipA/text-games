...
if __name__ == "__main__":
    ...
    st_inp = Input(shape=(1, 1)) # State (sentence) input will be a tensor of shape (batch x max_len x 1)
    st_h1 = LSTM(hidden_size, activation=activ(), unroll=True, consume_less=consumption, input_shape=(1, 1))(st_inp)
